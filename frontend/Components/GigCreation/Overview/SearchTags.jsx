    ...
    <div className="flex px-10 gap-[60px]">
      ...
      <div className="flex-[2]">
        ...
        <p className="pt-[10px] text-[18px] text-gray-400">
          Enter search terms you feel your buyers will use when <br /> looking for your service.
        </p>
        <div className="tags-container">
          ...
          <input
            type="text"
            className="w-full border-[1px] border-black mt-5 py-3 text-[20px]"
            value={tagInput}
        ...
        <p className="text-[16px] pt-2 text-gray-400">5 tags maximum. Use letters and numbers only.</p>
      </div>
    </div>
  );
};
