  ...
  return (
    <div className="w-full h-[1000px]">
      ...
      <div className="max-w-[1000px] basic-right h-[300px] border-[1px] rounded mx-[230px] mt-[10px]">
        <h3 className="text-[20px]  py-6 px-8">
        ...
        <textarea
          ...
          cols="30"
          rows="5"
          className="mx-8 w-[900px] py-4 px-7 border-[1px] text-[18px] resize-none"
      ...
      <button onClick={handleButtonCLick} className="bg-dark-blue mb-16 text-white py-4 px-8 ml-[1050px] mt-6 rounded-xl hover:bg-blue-950">
        Save & Continue
      </button>
